...
const Cuisines = () => {
  ...
  const handleGetRecipesByCuisineId = id => {
    ...
    if (selectedCuisine) {
      ...
      window.location.href = `http://localhost:3000/recipes?cuisine=${encodeURIComponent(selectedCuisine.name)}`;
    }
  };
      ...
      <div>
        {selectedCuisine ? (
          <div>
            ...
            {selectedCuisine && selectedCuisine.recipes && selectedCuisine.recipes.length > 0 ? (
              <div>
                <h2>Recipes:</h2>
                <ul>
